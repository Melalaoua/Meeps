...
class world(commands.Cog):
    def __init__(self,bot):
        ...
        self.scraping_list = scrape.fetch_scraping_list("world")
        self.cat_color = "0x3f826d"
    ...
    async def search_new_post(self):
        ...
        for scrape_name, data in self.scraping_list.items():
            data = await scrape.scrape_handler(self.web_client, self.db_pool, self.browser, scrape_name, data, guild, self.cat_color, cat_name="World")
